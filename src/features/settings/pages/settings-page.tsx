    ...
    <AppShell title="Settings" subtitle="Account, caregivers, and preferences">
      <div className="mx-auto max-w-4xl space-y-6">
        <Card className="rounded-2xl">
          <CardHeader>
            <CardTitle className="text-base">Family account</CardTitle>
          </CardHeader>
          <CardContent className="grid gap-4 sm:grid-cols-2">
            <div className="grid gap-2">
              <Label>Account name</Label>
              <Input defaultValue="Hayes Family" />
            </div>
            <div className="grid gap-2">
              <Label>Primary email</Label>
              <Input defaultValue="maria@carecircle.app" />
            </div>
            <div className="grid gap-2">
        ...
        <Card className="rounded-2xl">
          <CardHeader>
            <CardTitle className="text-base">Caregiver access</CardTitle>
          </CardHeader>
          ...
          <CardContent className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Up to 2 patients · 4 e-ink devices · unlimited reminders
              </p>
            </div>
