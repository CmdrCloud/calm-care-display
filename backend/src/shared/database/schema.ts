...
export const displayTemplateEnum = pgEnum("display_template", [
  "daily_summary", "next_reminder", "full_schedule", "message_card"
]);
export const notificationTypeEnum = pgEnum("notification_type", [
  "missed", "confirmed", "info", "reminder"
]);
export const messageStatusEnum = pgEnum("message_status", [
  "draft", "approved", "displayed", "archived"
]);
...
export const subscriptions = pgTable("subscriptions", {
  id: uuid("id").defaultRandom().primaryKey(),
  familyId: uuid("family_id").unique().notNull().references(() => families.id, { onDelete: "cascade" }),
